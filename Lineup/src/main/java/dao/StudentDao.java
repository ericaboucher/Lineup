...
public class StudentDao {
    ...
    public Student readStudent(UUID id) {
        Student student = null;
    ...
    public int createStudent(Student student) {
        ...
        try{
            ...
            stmt.setBoolean(5, student.getSignedIn());
    ...
    public int updateStudent(UUID id, String newFirstName, String newLastName, String newGuardian, Boolean signedIn) {
        int rowsAffected = 0;
